...
## 2. Первоначальная разметка набора данных
...
RT-DETR — отличный вариант, но на моей сборке и с текущей версией зависимостей он шёл заметно дольше по эпохе и требовал больше танцев с чекпоинтами. На дедлайне ставка на YOLO12s дала прогнозируемый результат быстрее.
